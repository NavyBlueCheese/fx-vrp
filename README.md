...
gap; it is the **gamma-weighted** gap
...
measures both objects on EUR/USD — the implied side from the CBOE EVZ index and FXE
...
implied series, while a daily scraper collects the live FXE surface going forward —
